    ...
    <div class="row">
        ...
        <div class="col-sm-9 tab-content">
                ...
                <div class="col-12">
                    ...
                    <div class="body px-5 py-2">
                        <div class="welcome-words">
                            ...
                            <p>Thanks, for being the part of OnlineShop. We welcome you to OnlineShop and will reach out to you for any problem.</p>
                        </div>
                        <div class="heading">
            ...
            <section id="account-details" class="row tab-pane fade">
                        ...
                        <form class="main-form full" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <input name="shippingCountryId" value="Pakistan" id="shippingcountryid" disabled class="form-control">
                                </div>
                                <div class="col-md-6">
                                <select name="shippingstateId" class="form-control" id="shippingstateid" placeholder="Select a Province">
                                    <?php 
                                        $sn=$q['state'];
            ...
            <section id="cart" class="row tab-pane fade">
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th colspan="2"> 
                                            <ul class="pull-right">
                                                <li class="price-box"><span class="mx-2">Total</span> <span class="price text-danger">PKR&nbsp;</span><span  id="price" class="price text-danger"><?php echo @$t;?></span></li>
                                            </ul>
                                        </th>
                                    </tr>
                                </thead>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="base-price price-box"> 
                                                <span class="price">PKR&nbsp;<?php echo $qpc['newPrice'];?> X <?php echo $value;?> = PKR&nbsp;<?php echo ($qpc['newPrice']*$value);?></span> 
                                            </div>
                                        </td>
                                        <td>
                ...
                <a href="buyNowCart.php" class="btn btnStyle">Checkout</a>
                </div>
            </section>
                            ...
                            <table class="table">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="base-price price-box"> 
                                                <span class="price">PKR&nbsp;<?php echo $qp['newPrice'];?></span> 
                                            </div>
                                        </td>
                                        <td class="lastbtns">
                                            <a class="btn btnStyle" href="single-product.php?category=<?php echo $qp['category']."&id=".$qp['id'];?>">View</a>
