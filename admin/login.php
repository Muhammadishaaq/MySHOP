...
<?php
	...
	if(isset($_POST['submit'])){
		...
		$pass = mysqli_real_escape_string($conn,$_POST['password']);
	  	...
	  	$r=mysqli_query($conn,"Select password from adminlogintb where emailId='$email'") or die(mysqli_error($conn));
            ...
            <div class="card-body">
              <form class="main-form full" method="post">
                <div class="row">
                 ...
                 <div class="col-7">
                    <button name="submit" type="submit" class="btn btnStyle pull-right">Log In</button>
                  </div>
                  <!-- <div class="col-12"> <a title="Forgot Password" class="forgot-password mtb-20" href="forgotpass.php">Forgot your password?</a> -->
                    <!-- <hr> -->
                  <!-- </div> -->
                  <div class="col-12">
                    <div class="new-account text-center mt-20"> <span>New to My Shop ?</span> <a class="link" title="Register with Everypick" href="register.php">Create New Account</a> </div>
                  </div>
                </div>
              </form>
            </div>
