                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            <select name="category" id="cat" class="form-control" placeholder="select a category">
                                ...
                                <option value="laptop" <?php if($cat=='laptop')echo "selected";?>>Cloths</option>
                                <option value="mobile" <?php if($cat=='mobile')echo "selected";?>>Perfumes</option>
                                <option value="camera" <?php if($cat=='camera')echo "selected";?>>Shoes</option>
                                <option value="watches" <?php if($cat=='watches')echo "selected";?>>Hand Bags</option>
