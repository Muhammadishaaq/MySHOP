            ...
            <div class="card-body">
              <form class="main-form full" method="post">
                <div class="row">
                 ...
                 <div class="col-12">
                    <button name="submit" type="submit" class="btn btnStyle pull-right form-control mt-2">Log In</button>
                  </div>
                  <div class="col-12 mt-1"> 
                  <a href="admin/login.php" style="text-align: right;">Admin Login</a>
                    <hr>
                  </div>
                  <div class="col-12">
                    <div class="new-account text-center mt-20"> <span>New to OnlineShop ?</span> <a class="link" title="Register with Everypick" href="register.php">Create New Account</a> </div>
                  </div>
                </div>
              </form>
            </div>
