        ...
        <form action="success.php" method="post">
            ...
            <div class="row">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="name" value="<?php echo $product['title']; ?>">
                </div>
            ...
            <div class="row">
                <div class="mb-3">
                    ...
                    <input type="text" name="amount" class="form-control" id="price" value="<?php echo $product['newPrice'] ?>">
                </div>
            </div>
            <div class="row">
