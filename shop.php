    ...
    <section class="result-sec row m-0">
        <aside class="aside bg-light col-sm-2">
            ...
            <div class="my-3">
                   ...
                   <input type="submit" value="submit" name="fsub" class="btn btnStyle my-3"> 
            </div>
            </form>
        </aside>
        ...
        <?php 
            ...
            // if(mysqli_fetch_assoc($qc)['sumcount']=' '){
        ...
        <div class="card result-card border-bottom ">
            <div class="card-body py-2">
                <div class="row">
                    ...
                    <div class="col-7">
                        <div class="title">
                            <a style="color: #345B63" href="<?php echo 'single-product.php?category='.$cat.'&id='.$q['id']; ?>"><?php echo $q['title']; ?></a>
                        </div>
