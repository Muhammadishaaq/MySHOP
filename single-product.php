                ...
                ?>
                    <div class="card">
                        ...
                        <div class="card-body pt-2">
                            ...
                            <a href="<?php echo 'single-product.php?id='.$qrp['id']; ?>" class="btn btnStyle px-5">View</a>
                        </div>
                    </div>
                <?php } ?>
                </div>
...
<tbody>
    ...
    <div class="qa mb-4 bg-dark  text-light p-3 rounded">
                ...
                <form method="POST">
                    ...
                    <button type="submit" class="btn btnStyle p-2" name="quesSubmit">Submit Question</button>
        ...
        <div class="Reviews">
            ...
            <h5>Customer Reviews</h5>
                ...
                <form method="POST">
                    ...
                    <div class="down row d-flex justify-content-between align-items-center">
                    ...
                    <button type="submit" name="submitRev" class="btn btn-warning col-md-7">Submit Review</button>
                    </div>
